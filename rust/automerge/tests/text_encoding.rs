...
//
//
// Currently the method is selected at compile time.
use automerge::{
    ...
    Scenario {
        ...
        action: |doc: &mut AutoCommit, text: &ObjId, encoding: Encoding| {
            let insert_index = match encoding {
                Encoding::UnicodeCodePoint => 8,
                Encoding::Utf8CodeUnit => 11,
                Encoding::Utf16CodeUnit => 9,
    ...
    Scenario {
        ...
        action: |doc: &mut AutoCommit, text: &ObjId, encoding: Encoding| {
            let end_index = match encoding {
                Encoding::UnicodeCodePoint => 4,
                Encoding::Utf8CodeUnit => 7,
                Encoding::Utf16CodeUnit => 5,
    ...
    Scenario {
        ...
        action: |doc: &mut AutoCommit, text: &ObjId, encoding: Encoding| {
            let cursor_index = match encoding {
                Encoding::UnicodeCodePoint => 3,
                Encoding::Utf8CodeUnit => 6,
                Encoding::Utf16CodeUnit => 4,
